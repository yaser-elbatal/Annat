...
const Parents = React.lazy(() =>
  import("./views/Components/Users/Parents/ParentList")
);

const Childern = React.lazy(() =>
  import("./views/Components/Users/Childern/ChildernList")
);
const ParentChild = React.lazy(() =>
  import("./views/Components/Users/Parents/ParentAndChild")
);
...
const Providers = React.lazy(() =>
  import("./views/Components/Users/Providers/ListProviders")
);
const Provider = React.lazy(() =>
  import("./views/Components/Users/Providers/Provider")
);
const Setting = React.lazy(() => import("./views/Components/Setting/Setting"));
...
const routes = [
  ...
  { path: "/parents", exact: true, name: "الاباء", component: Parents },
  { path: "/parents/:id", exact: true, name: "الاب", component: ParentChild },
  { path: "/children", exact: true, name: "الابناء", component: Childern },

  // { path: '/parents/:id', exact: true, name: 'الاب', component: ParentDetailes },
  //  { path: '/parents/:id', exact: true, name: 'الابن', component: ChildDetailes },

  { path: "/dashboard", name: "الرئيسية", component: Dashboard },
