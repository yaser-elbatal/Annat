...
export class myAccount extends Component {
  render() {
    ...
    return (
      <Subscription subscription={my_Acoount} variables={{ user_id: user_id }}>
        {({ loading, error, data }) => {
          if (loading)
            return (
                  ...
                  <div className="card" style={{ width: "25rem" }}>
                    ...
                    >
                      <li className="list-group-item">
                        <h5 style={{ float: "right" }}>اسم المستخدم :</h5>
                      ...
                      <li className="list-group-item">
                        <h5 style={{ float: "right" }}>البريد الاكتروني :</h5>
                        <span style={{ float: "left", fontSize: "16px" }}>
                          {admin.email}
                        </span>
                      </li>
                      ...
                      <li className="list-group-item">
                        <h5 style={{ float: "right" }}> تاريخ الانشاء:</h5>
                        <span style={{ float: "left", fontSize: "16px" }}>
                          {getDate(admin.created_at)}
                        </span>
                      </li>
                      <li className="list-group-item">
                        <h5 style={{ float: "right" }}>اخر تحديث :</h5>
                        <span style={{ float: "left", fontSize: "16px" }}>
                          {getDate(admin.updated_at)}
                        </span>
                      </li>
                      <li className="list-group-item">
                        <h5 style={{ float: "right" }}>الرقم السري :</h5>
                        <span style={{ float: "left", fontSize: "16px" }}>
                          {}
                        </span>
                      </li>
