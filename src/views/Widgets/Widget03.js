...
class Widget03 extends Component {
  render() {
    ...
    const { children, className, cssModule, dataBox, bodyBackBootstrapColor, bodyContent, ...attributes } = this.props;
    ...
    const classCardHeader = classNames(`${classCard}-header`, bodyBackBootstrapColor || back);
