...
import PopUp from '../../../myAccount/PopUp'
...
updatePayment()
    ...
    render() {
        ...
        return (
            <Mutation mutation={Edit_payment} 
            variables={{ payment_id:this.state.payment.id,
            ...
            }} refetchQueries={[{ query: AdminPaymentQuery, variables: { user_id: user_id } }]} >
            {(updatePayment, { data }) => (
                    <React.Fragment>
